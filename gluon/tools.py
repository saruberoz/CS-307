...
class Auth(object):
    ...
    def __init__(self, environment=None, db=None, mailer=True,
        ...
        messages.verify_password_comment = ''
    ...
    def navbar(self, prefix='Welcome,', action=None):
        ...
        if self.user_id:
            ...
            profile=A(T('My Account'),_href=action+'/profile')
            password=A(T('Password'),_href=action+'/change_password')
            bar=SPAN(prefix,self.user.first_name,' ',self.user.last_name,'! ',logout,_class='auth_navbar')
